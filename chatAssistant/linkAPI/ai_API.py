...
class Ws_Param(object):
    # 初始化 self是当前实例对象的本身，也就是他是一个Ws_Param类型的对象
...
if __name__ == "__main__":
    main(
        appid="4080a7d6",
        api_secret="MzFhOTk4MDNiMmZiZjk3NDE3YTU2Yzkw",
        api_key="3090a3764bb9d8c9d5057b7d2289aa83",
        #appid、api_secret、api_key三个服务认证信息请前往开放平台控制台查看（https://console.xfyun.cn/services/bm35）
        gpt_url="wss://spark-api.xf-yun.com/x2",
